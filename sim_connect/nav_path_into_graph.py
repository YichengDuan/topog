...
def create_graph_based_scene(scene_id, navmesh_path, config_path,distance_threshold = 3.0,block_tolerance = 0.5):
    ...
    # Load the navmesh into pathfinder
...
scene_id = "habitat-sim/data/scene_datasets/mp3d/17DRP5sb8fy/17DRP5sb8fy.glb"
navmesh_path = "habitat-sim/data/scene_datasets/mp3d/17DRP5sb8fy/17DRP5sb8fy.navmesh"
config_path = "habitat-sim/data/scene_datasets/mp3d/mp3d.scene_dataset_config.json"
graph = create_graph_based_scene(scene_id, navmesh_path, config_path)